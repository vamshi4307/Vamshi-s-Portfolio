...
export default function ProjectsSection() {
  ...
  const projects = [
    // Placeholder projects - user will add their own
    {
      ...
      githubUrl: "https://github.com/your-username/smart-sensor-ai",
    ...
    },
    {
      ...
      githubUrl: "https://github.com/your-username/matlab-control-sim",
      demoUrl: "https://demo-link.com",
      category: "control"
    },
    {
      ...
      githubUrl: "https://github.com/your-username/ml-portfolio",
      demoUrl: "https://demo-link.com",
      category: "web"
    }
  ]
  ...
  return (
    <section id="projects" className="py-20 relative bg-gray-50">
      <div className="container mx-auto px-6">
        ...
        >
          <h2 className="text-4xl md:text-6xl font-bold mb-6 text-black font-sora">Projects</h2>
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8 max-w-7xl mx-auto">
          {filteredProjects.map((project, index) => (
            <motion.div
              ...
              className="h-full"
            >
              <Card className="bg-white border-gray-200 shadow-lg hover:shadow-xl transition-all duration-300 h-full flex flex-col">
                <CardHeader>
                  <CardTitle className="text-xl text-black mb-2">{project.title}</CardTitle>
